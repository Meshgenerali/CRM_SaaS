    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-collapse class="ml-6 mt-2 space-y-1">
                    <a href="{{route('business.roles')}}" class="block px-4 py-2 text-gray-300 hover:bg-gray-700 rounded-lg">Roles</a>
                    <a href="{{route('business.invites')}}" class="block px-4 py-2 text-gray-300 hover:bg-gray-700 rounded-lg">Invite Users</a>
                </div>
            </div>
