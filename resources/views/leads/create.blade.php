<x-app-layout>
    ...
    <div class="max-w-lg mx-auto bg-gray-800 text-white p-8 rounded-lg shadow-lg">
        <h2 class="text-3xl font-bold mb-6">Add New Lead</h2>
        ...
        <form action="{{ route('leads.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea id="message" name="message" class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" rows="4">{{ old('notes') }}</textarea>
            </div>
