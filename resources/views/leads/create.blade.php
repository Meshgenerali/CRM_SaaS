            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                        ...
                        <div class="container mx-auto px-4 py-12">
                            <div class="max-w-lg mx-auto bg-gray-800 text-white p-8 rounded-lg shadow-lg">
                                <h2 class="text-3xl font-bold mb-6">Create Lead</h2>
                                ...
                                <form action="{{ route('leads.store') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="name" name="name" class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" value="{{ old('name') }}" required>
                                    </div>

                                    <!-- Email -->
                                    <div class="mb-4">
                                        <label for="email" class="block text-lg mb-2">Email</label>
                                        <input type="email" id="email" name="email" class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" value="{{ old('email') }}" required>
                                    </div>

                                    <!-- Phone -->
                                    <div class="mb-4">
                                        <label for="phone" class="block text-lg mb-2">Phone</label>
                                        <input type="text" id="phone" name="phone" class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" value="{{ old('phone') }}">
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <textarea id="message" name="message" class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" rows="4">{{ old('message') }}</textarea>
                                    </div>
